#!/usr/bin/env bash
# 手动镜像 liangdabiao/ecom-video-seedance-prompt 的 main 分支。
set -euo pipefail

UPSTREAM_URL="https://github.com/liangdabiao/ecom-video-seedance-prompt.git"
UPSTREAM_WEB_URL="https://github.com/liangdabiao/ecom-video-seedance-prompt"
UPSTREAM_BRANCH="main"
MIRROR_REPO="https://github.com/hopol/EcomAI-Bak"
...
git add upstream
git commit -m "chore: mirror EcomAI-Bak source $SOURCE_VALUE ($SHORT_COMMIT)"
git tag -a "mirror-source-$SHORT_COMMIT" -m "Mirror EcomAI-Bak source $SOURCE_VALUE ($SHORT_COMMIT)"
git push origin HEAD
git push origin "mirror-source-$SHORT_COMMIT"
echo "已同步 EcomAI-Bak $UPSTREAM_BRANCH：$UPSTREAM_COMMIT"
